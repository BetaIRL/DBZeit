...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->registerButton->Location = System::Drawing::Point(142, 173);
			...
			this->statusLabel->Location = System::Drawing::Point(53, 146);
			this->statusLabel->Name = L"statusLabel";
			this->statusLabel->Size = System::Drawing::Size(163, 13);
			...
			this->creatorLabel->Click += gcnew System::EventHandler(this, &LoginForm::linkLabel1_Click);
			// 
			// LoginForm
			// 
...
private: System::Void loginButton_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (rememberMeCheckBox->Checked)
	{
		if (login.good())
		{
			...
			DBZeitForm^ oDBZeitForm = gcnew DBZeitForm;
			oDBZeitForm->Show();
			this->Hide();
	...
	else
	{
		...
		if (nameTextBox->Text == cName && passwordTextBox->Text == cPassword)
		{
			DBZeitForm^ oDBZeitForm = gcnew DBZeitForm;
			oDBZeitForm->Show();
			this->Hide();
